...
IMAGE_NAME="${KNOWLEDGE_SSR_IMAGE:-knowledge-web-frontend}"
IMAGE_TAG="${KNOWLEDGE_SSR_TAG:-1.0.0}"
IMAGE_REGISTRY="$(resolve_harbor_registry_for_push "${KNOWLEDGE_SSR_IMAGE_REGISTRY:-harbor.sunmoonai.com}")"
IMAGE_PROJECT="${KNOWLEDGE_SSR_IMAGE_PROJECT:-app-images}"
